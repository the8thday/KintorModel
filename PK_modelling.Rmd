...
```{r}
my_pk <- readxl::read_excel('~/OneDrive/kintor/Daily_Work/8411-751_Concentration Table_01Jul2019.xls',
...
# 
conc_obj <- PKNCAconc(pk_GT0918, conc~Time|subject)
...
```{r}
pk_GT0918_1subject  <- pk_GT0918 %>% filter(subject == 1014)
