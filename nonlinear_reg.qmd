...
非线性模型是一系列模型的统称。在以前的笔记中所涉及到的GAM，splines, Polynomial 等都是非线性模型的应用。 GLMs也是将非线性的数据进行转换成线性而进行分析的。

GAM应该可以直接代替多项式、spline等模型。


1. Michaelis-Menten Regression model
...
The model is not appropriate for the observed data (or viceversa)
